...
vi: {
  ...
  referralOk:'🎁 Đã nhập mã! Chơi xong 1 ván để nhận thưởng nhé.', referralAlreadyUsed:'Bạn đã nhập mã mời rồi.',
...
en: {
  ...
  referralOk:'🎁 Code applied! Finish one run to get your reward.', referralAlreadyUsed:'You already used an invite code.',
...
ko: {
  ...
  referralOk:'🎁 코드 입력 완료! 한 판을 마치면 보상을 받아요.', referralAlreadyUsed:'이미 초대 코드를 입력했습니다.',
...
ja: {
  ...
  referralOk:'🎁 コードを適用しました！1プレイ終えると報酬がもらえます。', referralAlreadyUsed:'すでに招待コードを入力済みです。',
...
zh: {
  ...
  referralOk:'🎁 邀请码已输入！完成一局游戏即可获得奖励。', referralAlreadyUsed:'你已经输入过邀请码了。',
...
es: {
  ...
  referralOk:'🎁 ¡Código aplicado! Termina una partida para recibir tu recompensa.', referralAlreadyUsed:'Ya usaste un código de invitación.',
