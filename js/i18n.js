...
vi: {
  ...
  hintDefault:'Chạm khối · Kéo vào bàn · Thả để đặt',
  levelUp:'🎉 LÊN CẤP {0}!',
  // Tạm dừng / hết lượt
  ...
  lbTabLocal:'📱 Thiết bị', lbTabGlobal:'🌐 Toàn cầu', lbTabPvp:'⚔️ PvP',
  ...
  setSpin:'Vòng quay', spinTitle:'Lucky Spin', ttSpin:'Vòng quay may mắn',
...
en: {
  ...
  hintDefault:'Tap a piece · Drag to the board · Drop to place',
  levelUp:'🎉 LEVEL UP {0}!',
  ...
  lbTabLocal:'📱 Device', lbTabGlobal:'🌐 Global', lbTabPvp:'⚔️ PvP',
...
ko: {
  ...
  hintDefault:'블록 선택 · 보드로 드래그 · 놓아서 배치',
  levelUp:'🎉 레벨 업 {0}!',
...
ja: {
  ...
  hintDefault:'ブロックを選ぶ · ボードへドラッグ · 離して配置',
  levelUp:'🎉 レベルアップ {0}！',
...
es: {
  ...
  hintDefault:'Toca una pieza · Arrastra al tablero · Suelta para colocar',
