...
(function (g) {
  ...
  const BRICK_SKINS = [
    ...
    { id: "glass", name: "Glass", desc: { vi: 'Thủy tinh trong', en: 'Clear glass' }, price: 28 },
    ...
    { id: "wood", name: "Wood", desc: { vi: 'Gỗ vân ấm', en: 'Warm wood grain' }, price: 32 },
    ...
    { id: "matte", name: "Matte", desc: { vi: 'Nhám mờ', en: 'Matte finish' }, price: 19 },
    ...
    { id: "rubber", name: "Rubber", desc: { vi: 'Cao su', en: 'Rubber' }, price: 32 },
    { id: "jelly", name: "Jelly", desc: { vi: 'Thạch mềm', en: 'Soft jelly' }, price: 22 },
    { id: "pastel", name: "Pastel", desc: { vi: 'Pastel dịu', en: 'Soft pastel' }, price: 24 },
