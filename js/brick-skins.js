...
(function (g) {
  ...
  const BRICK_SKINS = [
    ...
    { id: "paper", name: "Paper", desc: { vi: 'Giấy gấp', en: 'Folded paper' }, price: 30 },
    { id: "chalk", name: "Chalk", desc: { vi: 'Phấn bảng', en: 'Chalkboard' }, price: 45 },
    { id: "stone", name: "Stone", desc: { vi: 'Đá thô', en: 'Rough stone' }, price: 45 },
    { id: "pixel", name: "Pixel", desc: { vi: 'Pixel 8-bit', en: 'Pixel' }, price: 60 },
    { id: "matte", name: "Matte", desc: { vi: 'Nhám mờ', en: 'Matte finish' }, price: 60 },
    { id: "ice", name: "Ice", desc: { vi: 'Băng giá', en: 'Icy frost' }, price: 75 },
    { id: "glossy", name: "Glossy", desc: { vi: 'Bóng gương', en: 'Mirror gloss' }, price: 75 },
    { id: "jelly", name: "Jelly", desc: { vi: 'Thạch mềm', en: 'Soft jelly' }, price: 75 },
    { id: "pastel", name: "Pastel", desc: { vi: 'Pastel dịu', en: 'Soft pastel' }, price: 75 },
    { id: "retro", name: "Retro", desc: { vi: 'Retro phẳng', en: 'Flat retro' }, price: 75 },
    { id: "glass", name: "Glass", desc: { vi: 'Thủy tinh trong', en: 'Clear glass' }, price: 90 },
    { id: "metal", name: "Metal", desc: { vi: 'Kim loại xước', en: 'Brushed metal' }, price: 90 },
    { id: "lava", name: "Lava", desc: { vi: 'Nham thạch', en: 'Molten lava' }, price: 90 },
    { id: "watercolor", name: "Watercolor", desc: { vi: 'Màu nước', en: 'Watercolor wash' }, price: 90 },
    { id: "ceramic", name: "Ceramic", desc: { vi: 'Sứ men', en: 'Glazed ceramic' }, price: 90 },
    { id: "wood", name: "Wood", desc: { vi: 'Gỗ vân ấm', en: 'Warm wood grain' }, price: 105 },
    { id: "leather", name: "Leather", desc: { vi: 'Da thật', en: 'Real leather' }, price: 105 },
    { id: "felt", name: "Felt", desc: { vi: 'Nỉ mềm', en: 'Soft felt' }, price: 105 },
    { id: "rubber", name: "Rubber", desc: { vi: 'Cao su', en: 'Rubber' }, price: 105 },
    { id: "bubble", name: "Bubble", desc: { vi: 'Bong bóng', en: 'Bubbly' }, price: 105 },
    { id: "neon", name: "Neon", desc: { vi: 'Ô neon + thú màu gạch thường', en: 'Neon tiles + pet icons' }, price: 120 },
    { id: "silver", name: "Silver", desc: { vi: 'Bạc lạnh', en: 'Cool silver' }, price: 120 },
    { id: "chroma", name: "Chroma", desc: { vi: 'Bóng ngọt + icon', en: 'Sweet gloss + icons' }, price: 135 },
    { id: "marble", name: "Marble", desc: { vi: 'Cẩm thạch', en: 'Marble stone' }, price: 150 },
    { id: "crystal", name: "Crystal", desc: { vi: 'Pha lê đa giác', en: 'Crystal facets' }, price: 165 },
    { id: "holo", name: "Holo", desc: { vi: 'Hologram', en: 'Holo' }, price: 210 },
    { id: "galaxy", name: "Galaxy", desc: { vi: 'Thiên hà', en: 'Galaxy space' }, price: 240 },
    { id: "gold", name: "Gold", desc: { vi: 'Vàng bóng', en: 'Shiny gold' }, price: 270 },
    { id: "chrome", name: "Chrome", desc: { vi: 'Chrome gương', en: 'Mirror chrome' }, price: 300 },
    { id: "mysticAurora", name: "Cực Quang Huyền Ảo", desc: { vi: 'Ánh cực quang lung linh', en: 'Shimmering aurora glow' }, diaPrice: 3 },
    { id: "mysticStardust", name: "Bụi Sao Lung Linh", desc: { vi: 'Bụi sao lấp lánh huyền ảo', en: 'Glittering mystic stardust' }, diaPrice: 3 },
    { id: "mysticMoonveil", name: "Màn Trăng Huyền Ảo", desc: { vi: 'Sương trăng huyền bí', en: 'Mystic moonlit veil' }, diaPrice: 3 },
    { id: "mysticEmber", name: "Lửa Ma Huyền Ảo", desc: { vi: 'Đốm lửa ma lung linh', en: 'Flickering phantom embers' }, diaPrice: 3 },
    { id: "mysticOpal", name: "Ngọc Mộng Huyền Ảo", desc: { vi: 'Ngọc mộng ảo lung linh', en: 'Dreamy opal shimmer' }, diaPrice: 3 },
    { id: "legendDragon", name: "Rồng Thần Huyền Thoại", desc: { vi: 'Vảy rồng thần lấp lánh', en: 'Shimmering divine dragon scales' }, diaPrice: 6 },
    { id: "legendPhoenix", name: "Phượng Hoàng Huyền Thoại", desc: { vi: 'Lửa phượng hoàng bất diệt', en: 'Undying phoenix flame' }, diaPrice: 6 },
    { id: "legendMeteor", name: "Thiên Thạch Huyền Thoại", desc: { vi: 'Sao băng xuyên vũ trụ', en: 'Meteor streaking through space' }, diaPrice: 6 },
    { id: "legendCrown", name: "Vương Miện Huyền Thoại", desc: { vi: 'Ngọc miện hoàng gia', en: 'Royal jeweled crown' }, diaPrice: 6 },
    { id: "legendEternal", name: "Vĩnh Hằng Huyền Thoại", desc: { vi: 'Sắc màu vĩnh hằng biến ảo', en: 'Ever-shifting eternal prism' }, diaPrice: 6 },
  ];
