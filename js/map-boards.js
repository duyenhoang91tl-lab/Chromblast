...
(function (g) {
  ...
  const BOARD_SKINS = [
    ...
    { id: "wood", name: "Wood", desc: { vi: 'Ván gỗ ấm', en: 'Warm wood planks' }, price: 72 },
    ...
    { id: "night", name: "Night", desc: { vi: 'Đêm sao', en: 'Starry night' }, price: 26 },
    { id: "sunset", name: "Sunset", desc: { vi: 'Hoàng hôn', en: 'Sunset glow' }, price: 56 },
    { id: "ice", name: "Ice", desc: { vi: 'Băng giá', en: 'Icy frost' }, price: 20 },
    { id: "lava", name: "Lava", desc: { vi: 'Nham thạch', en: 'Molten lava' }, price: 28 },
    { id: "sweet", name: "Sweet", desc: { vi: 'Nền ngọt pastel', en: 'Pastel sweet board' }, price: 34 },
    { id: "neon", name: "Neon", desc: { vi: 'Neon city', en: 'Neon city' }, price: 29 },
    { id: "sand", name: "Sand", desc: { vi: 'Cát vàng', en: 'Golden sand' }, price: 24 },
    ...
    { id: "paper", name: "Paper", desc: { vi: 'Giấy kraft', en: 'Kraft paper' }, price: 18 },
    ...
    { id: "cloud", name: "Cloud", desc: { vi: 'Mây trời', en: 'Sky clouds' }, price: 28 },
    ...
    { id: "berry", name: "Berry", desc: { vi: 'Quả mọng', en: 'Berry tones' }, price: 44 },
    { id: "desert", name: "Desert", desc: { vi: 'Sa mạc', en: 'Desert dunes' }, price: 36 },
    { id: "coral", name: "Coral", desc: { vi: 'San hô', en: 'Coral reef' }, price: 88 },
    { id: "storm", name: "Storm", desc: { vi: 'Bão tố', en: 'Stormy skies' }, price: 29 },
