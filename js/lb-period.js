...
(function (g) {
  ...
  const REWARD_TABLE = {
    day: [
      { max: 1, gold: 20, diamond: 3 },
      { max: 2, gold: 10, diamond: 2 },
      { max: 3, gold: 8, diamond: 1 },
    ...
    week: [
      { max: 1, gold: 40, diamond: 6 },
      { max: 2, gold: 30, diamond: 3 },
      { max: 3, gold: 20, diamond: 2 },
      { max: 10, gold: 10, diamond: 0 },
    ...
    month: [
      { max: 1, gold: 100, diamond: 10 },
      { max: 2, gold: 80, diamond: 5 },
      { max: 3, gold: 60, diamond: 3 },
      { max: 10, gold: 40, diamond: 0 },
      { max: 20, gold: 30, diamond: 0 },
