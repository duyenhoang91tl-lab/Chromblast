...
(function (g) {
  ...
  const REWARD_TABLE = {
    day: [
      { max: 1, gold: 25, diamond: 3 },
      { max: 2, gold: 15, diamond: 2 },
      { max: 3, gold: 10, diamond: 1 },
      { max: 10, gold: 6, diamond: 0 },
      { max: 20, gold: 4, diamond: 0 },
      { max: 40, gold: 3, diamond: 0 },
      { max: 60, gold: 2, diamond: 0 },
      { max: 80, gold: 1, diamond: 0 },
      { max: 100, gold: 1, diamond: 0 },
    ],
    week: [
      { max: 1, gold: 70, diamond: 6 },
      { max: 2, gold: 42, diamond: 3 },
      { max: 3, gold: 28, diamond: 2 },
      { max: 10, gold: 14, diamond: 0 },
      { max: 20, gold: 9, diamond: 0 },
      { max: 40, gold: 6, diamond: 0 },
      { max: 60, gold: 4, diamond: 0 },
      { max: 80, gold: 2, diamond: 0 },
      { max: 100, gold: 1, diamond: 0 },
    ],
    month: [
      { max: 1, gold: 280, diamond: 10 },
      { max: 2, gold: 175, diamond: 5 },
      { max: 3, gold: 105, diamond: 3 },
      { max: 10, gold: 53, diamond: 0 },
      { max: 20, gold: 32, diamond: 0 },
      { max: 40, gold: 18, diamond: 0 },
      { max: 60, gold: 11, diamond: 0 },
      { max: 80, gold: 7, diamond: 0 },
      { max: 100, gold: 4, diamond: 0 },
    ],
  };
