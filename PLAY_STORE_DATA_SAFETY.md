...
Hướng dẫn khai báo **Data safety** theo hành vi bản phát hành hiện tại (cập nhật 25/07/2026).  
...
1. **Does your app collect or share any of the required user data types?**  
   → **Yes** (ít nhất: User IDs khi online; Advertising nếu AdMob; Messages nếu chat).
